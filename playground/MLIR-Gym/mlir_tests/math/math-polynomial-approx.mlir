...
// RUN:   %mlir-opt %s -pass-pipeline="builtin.module(test-math-polynomial-approximation,convert-vector-to-scf,convert-scf-to-cf,convert-vector-to-llvm,convert-to-llvm,reconcile-unrealized-casts)" \
// RUN: | %mlir-translate --mlir-to-llvmir \
// RUN: | %clang -O0 -x ir -opaque-pointers - -o %t.custom %link-dir && (%t.custom > $t.custom.out) || true \
