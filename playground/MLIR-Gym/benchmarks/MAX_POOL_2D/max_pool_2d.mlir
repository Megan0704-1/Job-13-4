...
module {
  func.func @maxpool2d_nhwc_valid(%arg0: tensor<1x1024x1024x16384xf32>) -> tensor<1x512x512x16384xf32> {
    ...
    %2 = linalg.pooling_nhwc_max {dilations = dense<1> : vector<2xi64>, strides = dense<2> : vector<2xi64>} ins(%arg0, %cst_1 : tensor<1x1024x1024x16384xf32>, tensor<2x2xf32>) outs(%1 : tensor<1x512x512x16384xf32>) -> tensor<1x512x512x16384xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %6 = call @maxpool2d_nhwc_valid(%3) : (tensor<1x1024x1024x16384xf32>) -> tensor<1x512x512x16384xf32>
    return
  }
}
