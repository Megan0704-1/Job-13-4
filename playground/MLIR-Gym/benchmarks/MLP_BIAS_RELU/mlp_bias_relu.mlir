module {
    func.func @mlp_bias_relu(%A : tensor<2048x2048xf32>, %W : tensor<2048x2048xf32>, %B : tensor<2048xf32>) -> tensor<2048x2048xf32> {
    ...
    func.func @main() attributes {llvm.emit_c_interface} {
        ...
        %result = func.call @mlp_bias_relu(%A,%W,%B) : (tensor<2048x2048xf32>, tensor<2048x2048xf32>, tensor<2048xf32>) -> tensor<2048x2048xf32>
